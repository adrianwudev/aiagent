...
class PersistentFileMemory(ConversationBufferMemory):
    file_path: Optional[str] = "memory.json"  # Declare to an property with a default value

    def __init__(self, file_path="memory.json", **kwargs):
        super().__init__(**kwargs)
        object.__setattr__(self, "file_path", file_path)  # Use object.__setattr__ for pydantic
        self._load_memory()
