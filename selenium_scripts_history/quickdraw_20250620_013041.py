# --- Script Summary ---
# Purpose: Automate starting Quick, Draw! game by clicking 'Let's Draw!' and dismissing 'Got It!' overlays,
# then reading the drawing goal and entering drawing stage by clicking page body.
# Result: Successfully robustly started game and read drawing goal.
# Achieved: Good handling of blocking overlays and clicking buttons using legacy mouse events,
# successfully retrieved drawing prompt via quickdraw_word_reader and entered drawing stage.
# Score: 9.5/10
# Suggestions: Next improvements: implement drawing automation, add more recovery and error logging,
# enhance retry strategy with exponential backoff.
# ----------------------
